...
export const additionalResources: Resource[] = [
  ...
  {
    id: '21',
    name: 'Allegheny County Bar Association — Lawyer Referral Service',
    category: 'Legal Services',
    description: 'Lawyer referral and modest-means legal help for residents seeking an attorney in Allegheny County (separate from free legal aid eligibility).',
    address: '400 Koppers Building, 436 Seventh Avenue, Pittsburgh, PA 15219',
    location: parseAddress('436 Seventh Avenue, Pittsburgh, PA 15219', { lat: 40.4406, lng: -79.9961 }),
    phone: '(412) 261-5555',
    email: 'lrs@acba.org',
    website: 'https://www.acba.org',
    tags: ['Legal', 'Lawyer Referral', 'Attorney Services', 'Allegheny County'],
    featured: false,
    verified: true,
    coordinates: { lat: 40.4406, lng: -79.9961 },
    rating: 4.9,
  ...
  },
  {
    ...
    category: 'Support Services',
    description: 'Pittsburgh\'s community action agency: utility and housing referrals, food pantry, employment help, and economic mobility programs for city residents.',
    address: '249 N. Craig Street, Pittsburgh, PA 15213',
    location: parseAddress('249 N. Craig Street, Pittsburgh, PA 15213', { lat: 40.4406, lng: -79.9961 }),
    phone: '(412) 904-4700',
    email: 'info@pghcsi.org',
    website: 'https://pghcsi.org',
  ...
  {
    id: '30',
    name: 'Humane Animal Rescue of Pittsburgh',
    category: 'Community Programs',
    description: 'Adoption, lost and found, veterinary services, and humane education for pets and wildlife in the Pittsburgh region (East End and North Shore campuses).',
    address: '6926 Hamilton Avenue, Pittsburgh, PA 15208',
    location: parseAddress('6926 Hamilton Avenue, Pittsburgh, PA 15208', { lat: 40.4406, lng: -79.9961 }),
    phone: '(412) 345-7300',
    email: 'info@humaneanimalrescue.org',
  ...
  },
  {
    ...
    website: 'https://www.alleghenycounty.us/Services/Human-Services-DHS/DHS-Resources/Older-Adults',
  ...
  {
    id: '33',
    name: 'Jewish Family and Community Services (JFCS) Pittsburgh',
    category: 'Support Services',
    description: 'Refugee and immigrant services, career help, behavioral health, and family support for newcomers and residents across Greater Pittsburgh.',
    address: '5743 Bartlett Street, Pittsburgh, PA 15217',
    location: parseAddress('5743 Bartlett Street, Pittsburgh, PA 15217', { lat: 40.4200, lng: -79.9200 }),
    phone: '(412) 422-7200',
    email: 'info@jfcspgh.org',
    website: 'https://www.jfcspgh.org',
  ...
  {
    id: '34',
    name: 'Environmental Health Project',
    category: 'Health Services',
    description: 'Science-based advocacy and resources on environmental health risks (including air and water) for Southwestern Pennsylvania communities.',
    address: '720 Melwood Avenue, Pittsburgh, PA 15213',
    location: parseAddress('720 Melwood Avenue, Pittsburgh, PA 15213', { lat: 40.4406, lng: -79.9600 }),
    phone: '(412) 404-6181',
    email: 'info@ehp.org',
    website: 'https://www.ehp.org',
  ...
  },
  {
    ...
    category: 'Support Services',
    description: '211 helpline, financial stability programs, and connections to food, housing, and health resources across Allegheny and surrounding counties.',
    address: '1250 Penn Avenue, Pittsburgh, PA 15222',
    location: parseAddress('1250 Penn Avenue, Pittsburgh, PA 15222', { lat: 40.4406, lng: -79.9961 }),
    phone: '(412) 261-6010',
    email: 'info@unitedwayswpa.org',
    website: 'https://www.unitedwayswpa.org',
