  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[100rem] px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="flex min-h-[4.5rem] md:min-h-[5.25rem] w-full box-border items-center justify-between gap-2 py-2.5 md:py-3 md:grid md:grid-cols-[auto_minmax(0,1fr)_auto] md:items-center md:justify-items-stretch md:gap-x-3 lg:gap-x-5">
          ...
          <div className="hidden min-w-0 w-full md:flex md:justify-center md:px-2 lg:px-2.5">
            <div
