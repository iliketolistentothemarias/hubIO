  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[100rem] px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="flex min-h-[3.5rem] md:min-h-[4.25rem] w-full box-border items-center justify-between gap-2 py-0.5 md:py-1 md:grid md:grid-cols-[auto_minmax(0,1fr)_auto] md:items-center md:justify-items-stretch md:gap-x-2 lg:gap-x-4">
