  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[100rem] px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="flex min-h-[3.5rem] md:min-h-[4.25rem] w-full box-border items-center justify-between gap-2 py-0.5 md:py-1 md:grid md:grid-cols-[auto_minmax(0,1fr)_auto] md:items-center md:justify-items-stretch md:gap-x-3 lg:gap-x-6">
          ...
          <div className="hidden min-w-0 w-full md:flex md:justify-center md:px-2 lg:px-3">
            <div
              className="flex w-auto max-w-full min-w-0 flex-nowrap items-center justify-center gap-2 py-1 md:gap-2.5 lg:gap-3 xl:gap-4"
              ref={dropdownRef}
            >
              ...
              >
                {item.submenu ? (
                  <button
                    ...
                    className={`relative flex items-center gap-0.5 rounded-lg px-2 py-1.5 text-xs font-medium whitespace-nowrap transition-all duration-200 md:px-2.5 lg:px-3 lg:text-sm xl:text-base hover:bg-[#2C2416]/5 dark:hover:bg-[#F5F3F0]/10 ${item.submenu.some(sub => pathname === sub.href)
                  ...
                  <Link
                    href={item.href}
                    prefetch={true}
                    className={`relative flex items-center gap-0.5 rounded-lg px-2 py-1.5 text-xs font-medium whitespace-nowrap transition-all duration-200 md:px-2.5 lg:px-3 lg:text-sm xl:text-base hover:bg-[#2C2416]/5 dark:hover:bg-[#F5F3F0]/10 ${pathname === item.href
                        ? 'text-[#2C2416] dark:text-[#F5F3F0]'
                        : 'text-[#6B5D47] dark:text-[#B8A584] hover:text-[#8B6F47] dark:hover:text-[#D4A574]'
                      }`}
                  >
                    ...
                    {pathname === item.href && (
                      <motion.div
                        ...
                        className="absolute bottom-0 left-2 right-2 h-0.5 rounded-full bg-[#8B6F47] dark:bg-[#D4A574] md:left-2.5 md:right-2.5 lg:left-3 lg:right-3"
                        initial={false}
                      />
                    )}
                  </Link>
