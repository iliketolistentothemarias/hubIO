...
export default function Navigation() {
  ...
  return (
    <>
    <nav
      className={`fixed top-0 left-0 right-0 z-[50002] overflow-visible transition-all duration-200 [padding-top:max(6px,env(safe-area-inset-top,0px))] ${scrolled
    ...
    >
      <div className="mx-auto w-full max-w-[100rem] px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="flex min-h-[4rem] md:min-h-[4.75rem] w-full box-border items-center justify-between gap-2 py-1.5 md:py-2 md:grid md:grid-cols-[auto_minmax(0,1fr)_auto] md:items-center md:justify-items-stretch md:gap-x-2 lg:gap-x-3.5">
            ...
            {isOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="md:hidden fixed right-0 bottom-0 w-[280px] max-w-[85vw] bg-white dark:bg-[#1a1a1a] z-[50001] shadow-2xl overflow-y-auto overscroll-contain [top:calc(4rem+max(6px,env(safe-area-inset-top,0px)))]"
                >
