...
function MessagesContent() {
  ...
  useEffect(() => {
    if (showNewConversation && searchUsers.trim()) {
      searchForUsers()
    }
                ...
                {loadingUsers ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-[#6B5D47] dark:text-[#B8A584]">
                      {searchUsers.trim() ? 'No users found' : 'Search for users to start a conversation'}
                    </p>
                  </div>
                ) : (
                    ...
                    {users.map((user) => (
                      ...
                      >
                        ...
                        <div className="flex-1 text-left">
                          <p className="font-semibold text-[#2C2416] dark:text-[#F5F3F0]">{user.name}</p>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-[#E8E0D6] dark:border-[#2c2c3e] 
                             bg-white dark:bg-[#0B0A0F] text-[#2C2416] dark:text-[#F5F3F0]
                             focus:outline-none focus:ring-2 focus:ring-[#D4A574]"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-[#E8E0D6] dark:border-[#2c2c3e] 
                             bg-white dark:bg-[#0B0A0F] text-[#2C2416] dark:text-[#F5F3F0]
                             focus:outline-none focus:ring-2 focus:ring-[#D4A574] resize-none"
